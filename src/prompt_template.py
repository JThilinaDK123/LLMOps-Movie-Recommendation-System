...
def get_movie_prompt():
    template = """
You are an expert movie recommender. Your task is to help users find the perfect movies based on their preferences.

You are given a dataset where each record in the "description" column contains the movie name and its genre. Use this context to make thoughtful and personalized recommendations.
